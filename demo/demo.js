		...
		$scope.displayNotify = function (notify) {
			switch (notify) {
				...
				case 'grimace':
					...
					break;
				case 'htmlEscaped':
					ngNotify.set('<b>This</b> is a <i>notification</i> with <u>HTML content</u>.', {type:'info'});
					break;
				case 'html':
					ngNotify.set('<b>This</b> is a <i>notification</i> with <u>HTML content</u>.', {type:'info',html:true});
					break;
				default:
